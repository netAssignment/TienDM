...
namespace BookMgnt.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,Name,CategoriesID,Author,Introduce,imagePath,pubYear")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,Name,CategoriesID,Author,Introduce,imagePath,pubYear")] Book book)
        {
            if (ModelState.IsValid)
            {
